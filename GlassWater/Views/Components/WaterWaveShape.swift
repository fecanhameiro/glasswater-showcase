...
/// The wave is generated using sine functions for organic movement.
struct WaterWaveShape: Shape {
    /// The phase offset of the wave (0 to 2*pi), animated to create movement
    var phase: Double

    /// The amplitude of the wave in points (how tall the peaks are)
    var amplitude: CGFloat

    /// The frequency of the wave (how many complete waves across the width)
    var frequency: Double

    /// The fill level from 0 (bottom) to 1 (top)
    ...
    fileprivate func waveY(at x: CGFloat, width: CGFloat) -> CGFloat {
        ...
        // Normalize phase to 0-2π range for consistent rendering with continuous phase values
        ...
        // Secondary harmonic for more organic feel (smaller, faster)
